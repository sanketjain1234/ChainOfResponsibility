...
public class FiveHundredDispenserProcessor implements DispenserProcessor {
    private static int VALUE_OF_DISPENSER = 500;
    ...
    public void doProcess(int amount) {
        ...
        System.out.println("In FiveHundredDispenserProcessor,");
